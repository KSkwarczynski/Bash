...
input="$RUNPATH/scripts/filelistReco/SkimmedRun7MCprod6T-FGD2-antinu_00"
while IFS= read -r line
do
$SOFTPATH/skimFromCSV.exe -O file=$RUNPATH/scripts/ExtractedRun7MCprod6T-FGD2-antinu.csv -o $RUNPATH/recoFiltr/FGD2/MC/$line-filtr.root $RUNPATH/recoFiles/MC/$line
done < "$input"
