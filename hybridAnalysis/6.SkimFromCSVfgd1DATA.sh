...
input="$RUNPATH/scripts/filelistReco/SkimmedRun7DATAprod6T-FGD1-antinu_00"
while IFS= read -r line
do
$SOFTPATH/skimFromCSV.exe -O file=$RUNPATH/scripts/ExtractedRun7DATAprod6T-FGD1-antinu.csv -o $RUNPATH/recoFiltr/FGD1/Data/$line-filtr.root $RUNPATH/recoFiles/Data/$line
done < "$input"
