...
void CalcHybridAnalysisSampleEff()
{
    ...
    TFile *file = TFile::Open("/mnt/home/share/t2k/kskwarczynski/hybrid_analysis/Prod7/Efficiency/Output/Run7MCProd7.root");
    TTree *tree;
    file->GetObject("ana",tree);
    ...
    for(int d = 0;  d < N_FGDs; d++)
    {
        ...
        for(int j = 0;  j < Nbins; j++)
        {
            ...
            if(nCorrect[d][j] == 0) nCorrect[d][j] = 1;
